...
project = u'RCSDS'
copyright = u'2009-2015, K. Jarrod Millman, Christopher Paciorek'
author = u'K. Jarrod Millman, Christopher Paciorek'
...
latex_documents = [
  (master_doc, 'rcsds.tex', u'Reproducible and Collaborative Statistical Data Science',
   u'K. Jarrod Millman, Christopher Paciorek', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'rcsds', u'Reproducible and Collaborative Statistical Data Science',
   author, 'K. Jarrod Millman, Christopher Paciorek', 'One line description of project.',
   'Miscellaneous'),
]
